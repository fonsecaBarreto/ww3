...
var players = {}
var elements = [new Body([-300,-300,600,60],200),new Body([-300,300,600,60],200),new Body([-360,-300,60,660],200)]
var lastPosition = [0,0]
io.on("connection",function(socket){
  console.log("novo cliente")
  players[socket.id]= new Player([lastPosition[0]+64,lastPosition[1],64,96],colors[Math.floor(Math.random()*colors.length)]);
